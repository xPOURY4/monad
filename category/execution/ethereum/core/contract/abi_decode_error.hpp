...
template <>
struct quick_status_code_from_enum<monad::AbiDecodeError>
    : quick_status_code_from_enum_defaults<monad::AbiDecodeError>
{
    static constexpr auto const domain_name = "ABI Decode Error";
    static constexpr auto const domain_uuid =
        "3a486762-c4b6-4f0c-9e62-150eb96f4662";
