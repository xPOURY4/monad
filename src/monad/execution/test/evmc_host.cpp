...
TEST(EvmcHost, create_contract_account)
{
    constexpr static auto from{
        0x5353535353535353535353535353535353535353_address};
    ...
    traits_t::_fail_store_contract = false;
    ...
    auto const result2 = host.call(m);

    EXPECT_EQ(result2.create_address, new_addr);
    EXPECT_EQ(result2.gas_left, 7'000);
}

TEST(EvmcHost, fail_create_account)
{
    constexpr static auto from{
        0x5353535353535353535353535353535353535353_address};
