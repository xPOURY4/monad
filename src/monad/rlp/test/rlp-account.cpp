...
#include <monad/rlp/rlp-account.hpp>
...
TEST(Rlp_Account, Encode)
{
    ...
    static constexpr monad::uint256_t b{24'000'000};
    static constexpr monad::bytes32_t storage_root{
        0xbea34dd04b09ad3b6014251ee24578074087ee60fda8c391cf466dfe5d687d7b_bytes32};
    static constexpr monad::bytes32_t code_hash{
        0x6b8cebdc2590b486457bbb286e96011bdd50ccc1d8580c1ffb3c89e828462283_bytes32};
    monad::Account const a{.balance = b, .code_hash = code_hash};
    const monad::byte_string rlp_account{
    ...
    auto const encoded_account = monad::rlp::account::encode(a, storage_root);
    EXPECT_EQ(encoded_account.bytes, rlp_account);
}
