...
class monad_context_printer(gdb.ValuePrinter):
    r"""Default printer:
...
class monad_context_switcher_printer(gdb.ValuePrinter):
    r"""Default printer:
...
$2 = {user_ptr = 0x0, contexts = std::atomic<unsigned int> = { 10000 }, contexts_list = {lock = {__size = '\000' <repeats 17 times>, "\002", '\000' <repeats 21 times>, __align = 0}, front = 0x5060001d5ee0, back = 0x5060002c14a0, 
    count = 10000}, self_destroy = 0x55555575f338 <monad_context_switcher_none_destroy>, create = 0x55555575f4f8 <monad_context_none_create>, destroy = 0x55555575f758 <monad_context_none_destroy>, 
  suspend_and_call_resume = 0x55555575f7a8 <monad_context_none_suspend_and_call_resume>, resume = 0x55555575f848 <monad_context_none_resume>, resume_many = 0x55555575fde8 <monad_context_none_resume_many>}
    """
    def __init__(self, val):
        self.__val = val

    def display_hint(self):
        return 'monad_context_switcher'
...
def build_pretty_printer():
    ...
    pp.add_printer('monad_context', '^monad_context_head$', monad_context_printer)
    pp.add_printer('monad_context_switcher', '^monad_context_switcher_head$', monad_context_switcher_printer)
    return pp
