...
typedef struct monad_async_work_dispatcher_head
{
    ...
    {
        MONAD_ASYNC_ATOMIC(unsigned) working, idle;
    } executors;

    MONAD_ASYNC_PUBLIC_CONST MONAD_ASYNC_ATOMIC(size_t) tasks_awaiting_dispatch;
...
typedef struct monad_async_work_dispatcher_executor_head
{
    ...
    struct monad_async_work_dispatcher_head *MONAD_ASYNC_PUBLIC_CONST
        dispatcher;
    MONAD_ASYNC_PUBLIC_CONST MONAD_ASYNC_ATOMIC(bool) is_working, is_idle;
