...
namespace monad::utils
{
    ...
    /**
     * parse an evm opcode text file and return the resulting vector of evm
     * bytecode
     *
     * Notes:
     * case is ignored
     * data can be in hex or decimal form
     * pushes can be statically sized (e.g. push3 0xabcdef) or computed size
     * (e.g. push 0xabcdef) jumpdests can use named labels, e.g. push .mylabel
     * jumpdest .mylabel end of line comments (// .. \n) and whitespace are
     * ignored
     */
