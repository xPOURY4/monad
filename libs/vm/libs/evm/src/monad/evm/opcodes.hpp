...
namespace monad::compiler
{
    ...
    consteval std::array<OpCodeInfo, 256> make_opcode_table<EVMC_FRONTIER>()
    {
        return {
            ...
            OpCodeInfo{"DUP1", 0, 1, 1, false, 3, 1}, // 0x80,
            OpCodeInfo{"DUP2", 0, 2, 1, false, 3, 2}, // 0x81,
            OpCodeInfo{"DUP3", 0, 3, 1, false, 3, 3}, // 0x82,
            OpCodeInfo{"DUP4", 0, 4, 1, false, 3, 4}, // 0x83,
            OpCodeInfo{"DUP5", 0, 5, 1, false, 3, 5}, // 0x84,
            OpCodeInfo{"DUP6", 0, 6, 1, false, 3, 6}, // 0x85,
            OpCodeInfo{"DUP7", 0, 7, 1, false, 3, 7}, // 0x86,
            OpCodeInfo{"DUP8", 0, 8, 1, false, 3, 8}, // 0x87,
            OpCodeInfo{"DUP9", 0, 9, 1, false, 3, 9}, // 0x88,
            OpCodeInfo{"DUP10", 0, 10, 1, false, 3, 10}, // 0x89,
            OpCodeInfo{"DUP11", 0, 11, 1, false, 3, 11}, // 0x8A,
            OpCodeInfo{"DUP12", 0, 12, 1, false, 3, 12}, // 0x8B,
            OpCodeInfo{"DUP13", 0, 13, 1, false, 3, 13}, // 0x8C,
            OpCodeInfo{"DUP14", 0, 14, 1, false, 3, 14}, // 0x8D,
            OpCodeInfo{"DUP15", 0, 15, 1, false, 3, 15}, // 0x8E,
            OpCodeInfo{"DUP16", 0, 16, 1, false, 3, 16}, // 0x8F,

            OpCodeInfo{"SWAP1", 0, 1 + 1, 0, false, 3, 1}, // 0x90,
            OpCodeInfo{"SWAP2", 0, 1 + 2, 0, false, 3, 2}, // 0x91,
            OpCodeInfo{"SWAP3", 0, 1 + 3, 0, false, 3, 3}, // 0x92,
            OpCodeInfo{"SWAP4", 0, 1 + 4, 0, false, 3, 4}, // 0x93,
            OpCodeInfo{"SWAP5", 0, 1 + 5, 0, false, 3, 5}, // 0x94,
            OpCodeInfo{"SWAP6", 0, 1 + 6, 0, false, 3, 6}, // 0x95,
            OpCodeInfo{"SWAP7", 0, 1 + 7, 0, false, 3, 7}, // 0x96,
            OpCodeInfo{"SWAP8", 0, 1 + 8, 0, false, 3, 8}, // 0x97,
            OpCodeInfo{"SWAP9", 0, 1 + 9, 0, false, 3, 9}, // 0x98,
            OpCodeInfo{"SWAP10", 0, 1 + 10, 0, false, 3, 10}, // 0x99,
            OpCodeInfo{"SWAP11", 0, 1 + 11, 0, false, 3, 11}, // 0x9A,
            OpCodeInfo{"SWAP12", 0, 1 + 12, 0, false, 3, 12}, // 0x9B,
            OpCodeInfo{"SWAP13", 0, 1 + 13, 0, false, 3, 13}, // 0x9C,
            OpCodeInfo{"SWAP14", 0, 1 + 14, 0, false, 3, 14}, // 0x9D,
            OpCodeInfo{"SWAP15", 0, 1 + 15, 0, false, 3, 15}, // 0x9E,
            OpCodeInfo{"SWAP16", 0, 1 + 16, 0, false, 3, 16}, // 0x9F,
