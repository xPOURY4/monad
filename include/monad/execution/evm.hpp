...
inline evmc::Result deploy_contract_code(
...
template <evmc_revision rev, class EvmHost>
inline evmc::Result create_contract_account(
...
inline evmc_result transfer_call_balances(State &state, evmc_message const &msg)
{
